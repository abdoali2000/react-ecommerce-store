        ...
        <section className="relative h-[70vh] min-h-[440px] overflow-hidden rounded-3xl border shadow-[0_24px_80px_rgba(15,23,42,0.2)]" style={{ borderColor: "var(--card-border)", boxShadow: "0 24px 80px var(--card-shadow)" }}>
          ...
          >
            ...
            <motion.div variants={itemVariants} whileHover={{ y: -2 }} className="mt-8">
              <Link to="/products" className="inline-flex items-center gap-2 rounded-xl border border-[#6b0b0b]/30 bg-[#6b0b0b] px-8 py-3.5 text-sm font-semibold text-white shadow-xl transition hover:bg-[#7b1111] dark:border-[#D4AF37]/30 dark:bg-[#4a0404] dark:text-[#f6e7bf] dark:hover:bg-[#5c0909]">
