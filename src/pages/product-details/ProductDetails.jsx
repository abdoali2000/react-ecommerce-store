    ...
    <div className="min-h-screen bg-white px-6 py-10 text-slate-900 dark:bg-black dark:text-slate-100 sm:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-10 rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-[0_30px_80px_rgba(15,23,42,0.15)] backdrop-blur-xl dark:border-[#D4AF37]/20 dark:bg-[#0a0a0a] dark:shadow-[0_30px_80px_rgba(0,0,0,0.8)] md:flex-row md:p-10">
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold leading-tight text-slate-900 dark:text-slate-100">{product.title}</h1>
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-sm text-slate-600 dark:text-slate-300">({product.rating})</span>
          </div>
          ...
          <button
            ...
            className="mt-8 flex w-full items-center justify-center gap-2 rounded-xl border border-[#6b0b0b]/30 bg-[#6b0b0b] px-8 py-4 text-lg font-bold text-white shadow-[0_12px_30px_rgba(74,4,4,0.35)] transition hover:bg-[#7b1111] dark:border-[#D4AF37]/30 dark:bg-[#4a0404] dark:text-slate-100 dark:shadow-[0_12px_30px_rgba(74,4,4,0.6)] dark:hover:bg-[#5d0d0d]"
          >
            <ShoppingBag size={18} />
            Add to Cart
          </button>
